# Dinner-Menu_Static-website
A simple static web page that displays a Dinner Menu on a full-screen background image. The site is served via Nginx inside a Docker container.
...
Configuration
Nginx Port: The site is served by Nginx inside the container on port 8888. (See default.conf.)
